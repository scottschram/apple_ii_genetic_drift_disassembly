...
0043D9  90 02                         bcc  loc_0043DD      ; A=[$0010] X=$0001 Y=$0008 ; [SP-70]
0043DB  A9 09                         lda  #$09            ; A=$0009 X=$0001 Y=$0008 ; [SP-70]
0043DD  4C 16 04          loc_0043DD  jmp  $0416           ; A=$0009 X=$0001 Y=$0008 ; [SP-70]
...
0043EF  C9 D9                         cmp  #$D9            ; A=[$C000] X=$0001 Y=$0008 ; [SP-68]
0043F1  D0 05                         bne  loc_0043F8      ; A=[$C000] X=$0001 Y=$0008 ; [SP-68]
...
0043F8  C9 CA             loc_0043F8  cmp  #$CA            ; A=$0000 X=$0001 Y=$0008 ; [SP-66]
0043FA  D0 05                         bne  loc_004401      ; A=$0000 X=$0001 Y=$0008 ; [SP-66]
...
004401  C9 A0             loc_004401  cmp  #$A0            ; A=$0001 X=$0001 Y=$0008 ; [SP-64]
004403  D0 05                         bne  loc_00440A      ; A=$0001 X=$0001 Y=$0008 ; [SP-64]
...
00440A  C9 C7             loc_00440A  cmp  #$C7            ; A=$0002 X=$0001 Y=$0008 ; [SP-62]
00440C  D0 05                         bne  loc_004413      ; A=$0002 X=$0001 Y=$0008 ; [SP-62]
...
004413  C9 C1             loc_004413  cmp  #$C1            ; A=$0003 X=$0001 Y=$0008 ; [SP-60]
004415  F0 05                         beq  loc_00441C      ; A=$0003 X=$0001 Y=$0008 ; [SP-60]
004417  C9 C6                         cmp  #$C6            ; A=$0003 X=$0001 Y=$0008 ; [SP-60]
004419  F0 01                         beq  loc_00441C      ; A=$0003 X=$0001 Y=$0008 ; [SP-60]
; LUMA: epilogue_rts
00441B  60                            rts                  ; A=$0003 X=$0001 Y=$0008 ; [SP-58]
00441C  4C 81 53          loc_00441C  jmp  Fire4Dir        ; A=$0003 X=$0001 Y=$0008 ; [SP-58]
; LUMA: data_array_x
...
004443  F0 31                         beq  loc_004476      ; A=$0003 X=$0001 Y=$0008 ; [SP-58]
...
00444B  F0 45                         beq  loc_004492      ; A=$0003 X=$0001 Y=$0008 ; [SP-58]
...
; LUMA: data_array_x
004455  BD 6C 41          loc_004455  lda  $416C,X         ; A=$0051 X=$0000 Y=$0018 ; [SP-58]
...
004468  D0 EB                         bne  loc_004455      ; A=$0073 X=$0001 Y=$0018 ; [SP-58]
...
004473  4C 55 44                      jmp  loc_004455      ; A=[$0009] X=$006E Y=$0018 ; [SP-56]
; === End of while loop (counter: X) ===

004476  A0 09             loc_004476  ldy  #$09            ; A=[$0009] X=$006E Y=$0009 ; [SP-56]
...
004492  A0 1A             loc_004492  ldy  #$1A            ; A=$0000 X=$0060 Y=$001A ; [SP-54]
...
004AD0  20 28 5C                      jsr  sub_005C28      ; A=$0025 X=$0003 Y=[stk] ; [SP-94]
004AD3  A9 40                         lda  #$40            ; A=$0040 X=$0003 Y=[stk] ; [SP-94]
004AD5  20 6C 5C                      jsr  sub_005C6C      ; A=$0040 X=$0003 Y=[stk] ; [SP-96]
...
004AE0  F8                            sed                  ; A=[$C000] X=$0003 Y=[stk] ; [SP-94]
...
004B06  20 62 5B                      jsr  sub_005B62      ; A=$003C X=$0003 Y=$0000 ; [SP-98]
...
004B55  4C 62 5B                      jmp  sub_005B62      ; A=$0045 X=X-$01 Y=$0010 ; [SP-100]
...
004C0A  20 A1 52                      jsr  sub_0052A1      ; A=[stk] X=[stk] Y=$0002 ; [SP-110]
...
004C33  20 A1 52                      jsr  sub_0052A1      ; A=[stk] X=[stk] Y=$0002 ; [SP-110]
...
004C89  4C A1 52                      jmp  sub_0052A1      ; A=$0090 X=[stk] Y=$0002 ; [SP-111]
...
004CEF  AD 00 C0                      lda  KBD             ; KBD - Keyboard data / 80STORE off {Keyboard} <keyboard_read>
...
004D16  20 6C 5C                      jsr  sub_005C6C      ; A=$00FF X=[stk] Y=$0002 ; [SP-123]
...
004E0F  20 A1 52                      jsr  sub_0052A1      ; A=$0001 X=$0001 Y=$000A ; [SP-165]
...
004E62  20 A1 52                      jsr  sub_0052A1      ; Call $0052A1(A, X)
...
004EB7  20 A1 52                      jsr  sub_0052A1      ; Call $0052A1(A, X)
...
004F0C  20 A1 52                      jsr  sub_0052A1      ; Call $0052A1(A, X)
...
004FC4  20 E4 56                      jsr  IncreaseDifficulty ; A=$0008 X=$0003 Y=$0010 ; [SP-187]
...
0052A1  8D 7E 52          sub_0052A1  sta  $527E           ; A=[$0019] X=[$0019] Y=$0002 ; [SP-198]
...
0052CC  4C A1 52                      jmp  sub_0052A1      ; A=[$0019] X=[$0019] Y=$0002 ; [SP-202]
; === End of while loop (counter: $00) ===
...
00535E  4C 62 5B                      jmp  sub_005B62      ; A=$0045 X=$0002 Y=$0010 ; [SP-203]
...
005506  20 A1 52                      jsr  sub_0052A1      ; Call $0052A1(A, X, 1 stack)
; === End of while loop (counter: $00) ===
...
00556A  20 A1 52                      jsr  sub_0052A1      ; Call $0052A1(A, X, 1 stack)
...
0055E3  EE E1 55          sub_0055E3  inc  $55E1           ; A=A+$03 X=X-$01 Y=$0001 ; [SP-249]
...
0056C9  20 03 04          sub_0056C9  jsr  $0403           ; A=$0000 X=X-$01 Y=$0001 ; [SP-236]
...
00583E  10 06                         bpl  loc_005846      ; A=A-$01 X=$0002 Y=$0001 ; [SP-284]
...
005846  85 10             loc_005846  sta  $10             ; A=A-$01 X=$0002 Y=$0001 ; [SP-286]
...
005898  4C C3 58                      jmp  loc_0058C3      ; A=[$C061] X=$0002 Y=$0001 ; [SP-304]
00589B  25 2B                         and  $2B             ; A=[$C061] X=$0002 Y=$0001 ; [SP-304]
00589D  30 24                         bmi  loc_0058C3      ; A=[$C061] X=$0002 Y=$0001 ; [SP-304]
...
0058AA  D0 17                         bne  loc_0058C3      ; A=$0080 X=$0002 Y=$0001 ; [SP-304]
...
0058C3  20 87 4D          loc_0058C3  jsr  UpdateAlienPositions ; Call $004D87(A, X)
; === End of while loop (counter: $00) ===
...
005968  20 62 5B                      jsr  sub_005B62      ; Call $005B62(A, Y)
...
0059EB  20 E3 55                      jsr  sub_0055E3      ; A=A+$0B X=$0003 Y=$0014 ; [SP-334]
; === End of while loop (counter: $00) ===
...
005A01  20 C9 56                      jsr  sub_0056C9      ; Call $0056C9(A)
; === End of while loop (counter: $00) ===

005A04  E6 2E                         inc  $2E             ; A=[$57CC] X=$0003 Y=$0014 ; [SP-336]
...
005B04  20 62 5B                      jsr  sub_005B62      ; Call $005B62(A, Y)
...
005B3E  20 6C 5C                      jsr  sub_005C6C      ; Call $005C6C(A)
...
; Liveness: params(X,Y) returns(A,X,Y) [1 dead stores]
005B62  98                sub_005B62  tya                  ; A=$0080 X=$0003 Y=$0080 ; [SP-376]
...
005B6C  D0 F4                         bne  sub_005B62      ; A=A^$FF X=$0003 Y=$007F ; [SP-380]
; === End of loop (counter: Y) ===
...
005C25  B0 01                         bcs  sub_005C28      ; A=A+$01 X=$001E Y=$007F ; [SP-386]
005C27  60                            rts                  ; A=A+$01 X=$001E Y=$007F ; [SP-384]

; FUNC $005C28: register -> A:X []
; Liveness: returns(A,X,Y) [7 dead stores]
005C28  A9 00             sub_005C28  lda  #$00            ; A=$0000 X=$001E Y=$007F ; [SP-384]
...
005C6C  38                sub_005C6C  sec                  ; A=A^$FF X=A Y=A ; [SP-382]
...
005CCC  20 62 5B                      jsr  sub_005B62      ; Call $005B62(A, Y)
; === End of while loop (counter: A) ===
